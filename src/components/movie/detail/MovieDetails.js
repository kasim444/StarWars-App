...
import AttackClones
  from '../../../img/movies/Star-Wars-Attack-Clones-II-Poster.jpeg';
import PhantomMenace
  from '../../../img/movies/Star-Wars-Phantom-Menace-I-Poster.webp';
import RevengeSith
  from '../../../img/movies/Star-Wars-Revenge-Sith-III-Poster.webp';
...
class MovieDetails extends Component {
  ...
  async componentDidMount () {
    ...
    const movieDetail = await axios.get (
      `https://swapi.co/api/films/?search=${encodeURI (titleSearch)}`
    );
    const charactersFetchLinks = movieDetail.data.results[0].characters.slice (
      0,
      10
    );
      ...
      : (
        <div>
          <main className="movieBg">
            ...
            <MovieContent
              imgLink={moviesImageLinks[episode_id - 1]}
